...
export default async function LiveBoardPage(props: PageProps<"/board">) {
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <header className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <DateNav basePath="/board" dateStr={dateStr} />
            <ShiftFilterNav basePath="/board" dateStr={dateStr} value={shift} includeAll={false} />
          </div>
        </header>
